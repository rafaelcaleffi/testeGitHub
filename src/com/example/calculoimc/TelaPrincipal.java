...
public class TelaPrincipal extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btCalcular.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					vazio = "Campo altura n�o pode ser vazio.\n";
				}
				if(etPeso.getText().toString().equals(""))
				{
					vazio+= "Campo peso n�o pode ser vazio.";
				}
				...
				{
					mensagemExibir("IMC", "Seu IMC �: "+resultado+". \nVoc� est� abaixo do Peso.");
				}
				...
				{
					mensagemExibir("IMC", "Seu IMC �: "+resultado+". \nVoc� est� marginalmente acima do peso.");
				}
	...
	{
		AlertDialog.Builder mensagem = new AlertDialog.Builder(TelaPrincipal.this);
